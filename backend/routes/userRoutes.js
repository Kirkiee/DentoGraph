...
router.get('/dentist/dashboard', authenticateToken, authorizeRoles('Dentist'), (req, res) => {
  res.json({
...
router.get('/patient/dashboard', authenticateToken, authorizeRoles('Patient'), (req, res) => {
  res.json({
...
router.get('/assistant/dashboard', authenticateToken, authorizeRoles('Assistant'), (req, res) => {
  res.json({
...
router.get('/clinical-area', authenticateToken, authorizeRoles('Dentist', 'Assistant'), (req, res) => {
  res.json({
