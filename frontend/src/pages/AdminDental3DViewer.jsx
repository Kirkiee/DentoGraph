    ...
    try {
      ...
      setError(
        err.response?.data?.error ||
          "Unable to load admin 3D dental record data.",
      );
    } finally {
      setLoading(false);
    }
    ...
    <DashboardLayout role="Admin">
      <div className="appointments-list-card">
        <div className="appointments-header">
          <div>
            <h2>Admin 3D Dental Visualization</h2>
            <p>
              View this patient dental record in 3D. This admin view is
              read-only and is intended for oversight and demonstration.
            </p>
          </div>
          ...
          <div className="appointment-actions" style={{ flexDirection: "row" }}>
            <button
              ...
              onClick={() => navigate(`/admin/dental-records/${record_id}`)}
            >
              Back to Record
            </button>
...
export default AdminDental3DViewer;
