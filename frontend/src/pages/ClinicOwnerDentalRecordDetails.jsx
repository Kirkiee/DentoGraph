...
function ClinicOwnerDentalRecordDetails() {
      ...
      <div className="appointments-list-card dental-record-details-page">
        <div className="appointments-header no-print">
          <div>
            ...
            <p>
              View teeth, treatments, X-rays, AR simulations, and uploaded
              patient documents connected to this dental record. This view is
              read-only.
            </p>
          </div>
          ...
          <div className="appointment-actions" style={{ flexDirection: "row" }}>
            <button
              ...
              onClick={() => navigate("/clinic-owner/dental-records")}
            >
              Back to Records
            </button>
            ...
            <button
              ...
              onClick={() =>
                navigate(`/clinic-owner/dental-records/${record_id}/3d-view`)
              }
              disabled={loading || !record}
            >
              3D View
              ...
              <div className="appointments-header">
                ...
                >
                  <button
                    ...
                    onClick={() =>
                      navigate(
                        `/clinic-owner/dental-records/${record_id}/3d-view`,
                      )
                    }
                  >
                    Open 3D Chart
...
export default ClinicOwnerDentalRecordDetails;
