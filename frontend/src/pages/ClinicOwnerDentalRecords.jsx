...
function ClinicOwnerDentalRecords() {
  ...
  const handleCreateRecord = async (e) => {
    ...
    try {
      ...
      if (response.data.existing) {
        ...
        if (existingRecordId) {
          navigate(`/clinic-owner/dental-records/${existingRecordId}`);
        }
      ...
      <div className="appointments-list-card">
        <div className="appointments-header">
          <div>
            ...
            <p>
              Search and review current and historical dental records from
              clinic locations you own. Clinical information is read-only.
            </p>
          </div>
            ...
            {policyError.existingRecord && (
              <div style={{ marginTop: "10px" }}>
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      `/clinic-owner/dental-records/${policyError.existingRecord.record_id}`,
                    )
                  }
                  style={{ marginTop: "8px" }}
                >
                ...
                >
                  ...
                  <div className="appointment-actions dentist-record-actions">
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `/clinic-owner/dental-records/${record.record_id}`,
                        )
                      }
                    >
                      View Details
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `/clinic-owner/dental-records/${record.record_id}/3d-view`,
                        )
                      }
                    >
                      3D Chart
...
export default ClinicOwnerDentalRecords;
