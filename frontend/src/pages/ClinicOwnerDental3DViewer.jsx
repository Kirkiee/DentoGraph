...
function ClinicOwnerDental3DViewer() {
  const readOnly = true;
  ...
  return (
    <DashboardLayout role="Clinic Owner">
      <div className="appointments-list-card">
        <div className="appointments-header">
          <div>
            ...
            <p>
              View the Patient's interactive 3D dental chart and complete
              tooth-status history. Clinic Owner access is read-only.
            </p>
          </div>
          ...
          <div className="appointment-actions" style={{ flexDirection: "row" }}>
            <button
              ...
              onClick={() =>
                navigate(`/clinic-owner/dental-records/${record_id}`)
              }
            >
              Back to Record
            </button>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="info-message">
              <strong>Read-only historical view:</strong> Tooth conditions and
              their recorded change history are shown exactly as documented by
              the originating clinic. Clinic Owners cannot edit clinical data
              from this page.
            </div>
      ...
      {!readOnly && showReasonModal && selectedTooth && (
        <div className="modal-overlay">
          <div className="modal-card">
            <div className="modal-header">
              <div>
...
export default ClinicOwnerDental3DViewer;
